...
Windows and macOS version will start with double-clicking on the executable
...
button. On macOS, control+click and option+click mean the right button and
...
of these parameters also can be set by the preference dialog. macOS version
...
- Reading and Writing
  ...
  * AIFC file (8bits PCM, 16bits PCM, 24bits PCM, 32bits PCM, 32bits float PCM,
    ulaw, alaw)
  * CAF file (8bits PCM, 16bits PCM, 24bits PCM, 32bits PCM, 32bits float PCM,
    64bits double PCM, ulaw, alaw)
...
spwave is known to work at least on Windows Vista/7/8/10, macOS 10.7-10.14, 
...
The official web site is:
  http://www-ie.meijo-u.ac.jp/labs/rj001/spLibs/spwave/index.html
