...
class1_myu=[np.matrix([[1],[1]]),np.matrix([[0],[0]])]


class1_sigma=[np.matrix([[1,0], [0,1]]),np.matrix([[1,0], [0,1]])]
...
class2_myu=[np.matrix([[1],[1]]),np.matrix([[0],[0]])]


class2_sigma=[np.matrix([[1,0], [0,1]]),np.matrix([[1,0], [0,1]])]
...
print("クラス識別")
print("")
print("class1,class2の学習データから求めた混合正規分布を用いて識別を行う")
print("-----------------------")
...
ax.scatter(float(class1_myu[1][0][0]),float(class1_myu[1][1][0]),s=50,c='red',marker="x")
...
ax.scatter(float(class2_myu[1][0][0]),float(class2_myu[1][1][0]),s=50,c='green',marker="x")
